...
class TargetPreviewFullscreenEventListener implements InAppMessageEventListener {
    ...
    public void onDismiss(@NonNull final Presentable<InAppMessage> presentable) {
        Log.debug(
                ...
                CLASS_NAME,
                "Target preview selection screen was dismissed");
    }
    ...
    public void onError(
        ...
        Log.debug(
                TargetConstants.LOG_TAG,
                CLASS_NAME,
                "onError - Failed to display Target preview selection screen.");
    }
    ...
    public void onShow(@NonNull final Presentable<InAppMessage> presentable) {
        Log.debug(
                TargetConstants.LOG_TAG,
                CLASS_NAME,
                "Target preview selection screen was displayed");
    }
    ...
    public boolean onUrlLoading(
            @NonNull final Presentable<InAppMessage> presentable, @NonNull final String url) {
        Log.debug(
                TargetConstants.LOG_TAG,
                CLASS_NAME,
                String.format("Target preview override url received: %s", url));
