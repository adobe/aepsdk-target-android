...
public class TargetResponseParserTest {
    ...
    public void testParseResponseToJson_Happy() throws Exception {
        ...
        try (MockedStatic<StreamUtils> streamUtilsMock = Mockito.mockStatic(StreamUtils.class)) {
            streamUtilsMock
                    .when(() -> StreamUtils.readAsString(Mockito.any()))
                    .thenReturn(
                            "{\n"
                                    + "  \"prefetch\" : {\n"
                                    + "    \"mboxes\" : [{\n"
    ...
    public void testExtractPrefetchedMboxes_Happy() throws Exception {
        ...
        // test
        Map<String, JSONObject> prefetchedMboxes =
                responseParser.extractPrefetchedMboxes(jsonObject);
    ...
    @Test
    public void testExtractPrefetchedMboxes_Will_ReturnNull_When_PrefetchMboxInvalidType()
            throws Exception {
        // setup
        String serverResponse = "{\n" + "  \"prefetch\": \"ItsAString\"\n" + "}";
        JSONObject jsonObject = new JSONObject(serverResponse);
    ...
    @Test
    public void
            testExtractPrefetchedMboxes_Will_ReturnEmptyMap_When_PrefetchResponseContainsOneItemWithEmptyMbox()
                    throws Exception {
        // setup
        String serverResponse =
                "{\n"
    ...
    @Test
    public void testExtractBatchedMBoxes_Will_ReturnNull_When_MboxResponseInvalidType()
            throws Exception {
        // setup
        String serverResponse =
                "{\n" + "  \"execute\": {\n" + "  \"mboxes\": \"ItsAString\"" + "  }\n" + "}";
    ...
    @Test
    public void
            testExtractBatchedMBoxes_Will_ReturnEmptyMap_When_MboxResponseContainsOneItemWithEmptyMbox()
                    throws Exception {
        // setup
        String serverResponse =
                "{\n"
    ...
    public void testGetAnalyticsForTargetPayload_Happy() throws Exception {
        ...
        // test
        Map<String, String> a4tPayloadMap =
                responseParser.getAnalyticsForTargetPayload(jsonObject, FAKE_SESSION_ID);
        ...
        assertEquals(
                a4tPayloadMap.get(TargetTestConstants.EventDataKeys.A4T_SESSION_ID),
                FAKE_SESSION_ID);
    }
    ...
    public void testGetAnalyticsForTargetPayload_Happy_With_Null_Session_Id() throws Exception {
        ...
        // test
        Map<String, String> a4tPayloadMap =
                responseParser.getAnalyticsForTargetPayload(jsonObject, null);
    ...
    public void testGetAnalyticsForTargetPayload_Happy_With_Empty_Session_Id() throws Exception {
        ...
        // test
        Map<String, String> a4tPayloadMap =
                responseParser.getAnalyticsForTargetPayload(jsonObject, "");
    ...
    @Test
    public void testExtractMboxContent_Will_ReturnEmpty_When_ExtractMboxContentInvalidType()
            throws Exception {
        // setup
        String serverResponse =
                "{\n"
    ...
    @Test
    public void testExtractA4TParams_Will_Return_Valid_Map_When_Analytics_Payload_Is_Present()
        ...
        // Assertions
        Map<String, String> a4tParams =
                responseParser.getAnalyticsForTargetPayload(mBoxPayloadObject);
    ...
    @Test
    public void testExtractA4TParams_Will_Return_Null_When_Analytics_Payload_Is_Missing()
            throws JSONException {
        // setup
        final String mboxPayload =
                "{\n"
    ...
    @Test
    public void
            testExtractResponseTokens_Will_Return_Valid_Map_When_Response_Tokens_Payload_Is_Present()
                    throws JSONException {
        // setup
        final String mboxPayload =
                "{\n"
        ...
        assertEquals(
                new ArrayList<String>(Arrays.asList("shoes")),
                responseTokens.get("profile.categoryAffinities"));
    }

    @Test
    public void testExtractResponseTokens_Will_Return_Null_When_response_Tokens_Payload_Is_Missing()
            throws JSONException {
        // setup
        final String mboxPayload =
                "{\n"
    ...
    @Test
    public void testExtractResponseTokens_Will_Return_Null_When_Mbox_Payload_Is_Null()
            throws JSONException {
        // setup
    ...
    @Test
    public void testExtractResponseTokens_Will_Return_Null_When_Response_Tokens_Payload_Is_Invalid()
            throws JSONException {
        try (MockedStatic<JSONUtils> jsonUtilsMock = Mockito.mockStatic(JSONUtils.class)) {
            // setup
            jsonUtilsMock
                    .when(() -> JSONUtils.toMap(Mockito.any()))
            ...
            // test
            Map<String, Object> responseTokens =
                    responseParser.getResponseTokens(mBoxPayloadObject);
    ...
    @Test
    public void
            testExtractClickMetricAnalyticsPayload_Will_Return_Valid_Map_When_Analytics_Payload_Is_Present()
                    throws JSONException {
        // setup
        final String mboxPayload =
                "{\n"
        ...
        // Assertions
        Map<String, String> clickMetricsA4TParams =
                responseParser.extractClickMetricAnalyticsPayload(mBoxPayloadObject);
    ...
    @Test
    public void
            tesExtractClickMetricAnalyticsPayload_Will_Return_Null_When_Analytics_Payload_Is_Missing()
                    throws JSONException {
        // setup
        final String mboxPayload =
                "{\n"
    ...
    @Test
    public void testExtractClickMetricAnalyticsPayload_Will_Return_Null_When_EventTokenIsMissing()
            throws JSONException {
        // setup
        final String mboxPayload =
                "{\n"
    ...
    public void test_preprocessAnalyticsForTargetPayload_Should_Return_Correctly_Formatted_Map() {
        ...
        Map<String, String> processedMap =
                responseParser.preprocessAnalyticsForTargetPayload(a4tParams, sessionId);
    ...
    public void test_preprocessAnalyticsForTargetPayload_Should_Return_Null() {
        ...
        // Action
        Map<String, String> processedMap =
                responseParser.preprocessAnalyticsForTargetPayload(null, sessionId);
    ...
    public void test_getClickMetric_ShouldReturn_ClickMetricObject() throws JSONException {
        ...
        assertEquals(
                "tnt",
                clickMetric.getJSONObject("analytics").getJSONObject("payload").getString("pe"));
        assertEquals(
                "333911:0:0:0|32767",
                clickMetric.getJSONObject("analytics").getJSONObject("payload").getString("tnta"));
    }

    @Test
    public void test_getClickMetric_ShouldReturnNull_WhenClickMetricIsMissing()
            throws JSONException {
        final String mboxJsonString =
                "{\n"
                        + "            \"index\":0,\n"
    ...
    @Test
    public void test_getClickMetric_ShouldReturnNull_WhenEventTokenIsMissing()
            throws JSONException {
        final String mboxJsonString =
                "{\n"
                        + "            \"index\":0,\n"
