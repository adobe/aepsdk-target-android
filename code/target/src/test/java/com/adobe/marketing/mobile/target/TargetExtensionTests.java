...
public class TargetExtensionTests {
    ...
    private static final Map<String, String> responseTokens = new HashMap() {{
    ...
    public void testLoadRequests_whenValidResponse() {
        runWithMockedServiceProvider(() -> {
            ...
            try {
                validMboxResponse = new JSONObject("{\"options\": [{\"content\": \"mbox0content\", \"type\": \"html\"}]}");
            } catch (JSONException e) {
                throw new RuntimeException(e);
            }
            try {
    ...
    public void testHandleRawRequest_SendNotification_When_RequestPayloadIsValid() {
        runWithMockedServiceProvider(() -> {
            ...
            JSONObject json = null;
            try {
                json = new JSONObject("{\"mbox\": {\"name\": \"mbox1\"}, \"tokens\":[\"someToken\"]}");
            } catch (JSONException e) {
                throw new RuntimeException(e);
            }
            when(requestBuilder.getRequestPayload(any(), any(), any(), any(), any())).thenReturn(json);
