...
public class TargetParametersTests {
    ...
    public void testMerge_happy() {
        ...
        final TargetParameters targetParamsWithProduct = new TargetParameters.Builder()
                .product(PRODUCT_PARAMETERS_HAPPY_PATH)
                .build();
        final TargetParameters targetParamsWithOrder = new TargetParameters.Builder()
                .order(ORDER_PARAMETERS_HAPPY_PATH)
                .build();
        final TargetParameters targetParamsWithProfileAndMboxParameters = new TargetParameters.Builder()
                .profileParameters(PROFILE_PARAMETERS_HAPPY_PATH)
                .parameters(MBOX_PARAMETERS_HAPPY_PATH)
                .build();
        ...
        final TargetParameters mergedTargetParameters = TargetParameters.merge(targetParametersList);
    ...
    public void testMerge_differentMboxParametersInList() {
        ...
        final TargetParameters targetParametersWithMboxParameters = new TargetParameters.Builder()
        ...
        final TargetParameters mergedTargetParameters1 = TargetParameters.merge(targetParametersList);
