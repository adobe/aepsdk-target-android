...
public class TargetRequestBuilderTest {
    ...
    // setup
    static Map<String, String> lifecycleData =
    ...
    @Mock TargetState mockTargetState;
    ...
    public void beforeEach() {
        targetRequestBuilder =
                new TargetRequestBuilder(
                        mockDeviceInfoService, mockTargetPreviewManager, mockTargetState);
    }
    ...
    public void getRequestPayload_PrefetchInJson_When_PrefetchListContainsOneObject() {
        ...
        JSONObject json =
                targetRequestBuilder.getRequestPayload(
                        getTargetPrefetchList(1), null, null, null, null, null, null);

        // verify
        assertEquals(1, json.optJSONObject(PREFETCH_MBOXES).optJSONArray(MBOXES).length());
        assertEquals(
                0,
                json.optJSONObject(PREFETCH_MBOXES)
                        .optJSONArray(MBOXES)
                        .optJSONObject(0)
                        .opt(INDEX));
        assertEquals(
    ...
    public void getRequestPayload_PrefetchInJson_When_PrefetchListContainsTwoObjects() {
        ...
        JSONObject json =
                targetRequestBuilder.getRequestPayload(
                        getTargetPrefetchList(2), null, null, null, null, null, null);
    ...
    public void getRequestPayload_PrefetchInJson_When_PrefetchListIsEmptyOrNull() {
        ...
        JSONObject json =
                targetRequestBuilder.getRequestPayload(
                        getTargetPrefetchList(0), null, null, null, null, null, null);
    ...
    public void getRequestPayload_ProfileWhen_ProfileParametersIsValid() {
        ...
        // test
        JSONObject json =
                targetRequestBuilder.getRequestPayload(null, null, params, null, null, null, null);
    ...
    public void getRequestPayload_BatchInJson_When_BatchListContainsOneObject() {
        ...
        JSONObject json =
                targetRequestBuilder.getRequestPayload(
                        null, getTargetRequestList(1), null, null, null, null, null);

        // verify
        assertEquals(1, json.optJSONObject(EXECUTE_MBOXES).optJSONArray(MBOXES).length());
        assertEquals(
                0,
                json.optJSONObject(EXECUTE_MBOXES)
                        .optJSONArray(MBOXES)
                        .optJSONObject(0)
                        .opt(INDEX));
        assertEquals(
                "mbox0",
                json.optJSONObject(EXECUTE_MBOXES).optJSONArray(MBOXES).optJSONObject(0).opt(NAME));
    }
    ...
    public void getRequestPayload_BatchInJson_When_BatchListContainsTwoObjects() {
        ...
        JSONObject json =
                targetRequestBuilder.getRequestPayload(
                        null, getTargetRequestList(2), null, null, null, null, null);
        ...
        assertEquals(
                "mbox1",
                json.optJSONObject(EXECUTE_MBOXES).optJSONArray(MBOXES).optJSONObject(1).opt(NAME));
    }
    ...
    public void getRequestPayload_BatchNotInJson_When_BatchListIsEmptyOrNull() {
        ...
        JSONObject json =
                targetRequestBuilder.getRequestPayload(
                        null, getTargetRequestList(0), null, null, null, null, null);
        // verify
        assertNull(json.optJSONObject(EXECUTE_MBOXES));
    ...
    public void getRequestPayload_NotificationInJson_When_NotificationListContainsOneObject() {
        ...
        JSONObject json =
                targetRequestBuilder.getRequestPayload(
                        null, null, null, notifications, null, null, null);
    ...
    public void getRequestPayload_PreviewInJson_When_PreviewTokenAndPreviewParameterValid() {
        ...
        Mockito.when(mockTargetPreviewManager.getPreviewParameters())
                .thenReturn("{\"qaMode\":{\"key\":\"value\"}}");

        // test
        JSONObject json =
                targetRequestBuilder.getRequestPayload(null, null, null, null, null, null, null);
    ...
    public void getRequestPayload_OrderWhen_OrderParametersAreValid() {
        ...
        TargetParameters targetParameters =
                new TargetParameters.Builder().order(targetOrder).build();
        TargetRequest targetRequest =
                new TargetRequest("mbox", targetParameters, "default", callback -> {});
        ...
        JSONObject json =
                targetRequestBuilder.getRequestPayload(
                        null, targetRequestList, null, null, null, null, null);
        ...
        assertEquals(
                ...
                json.optJSONObject(EXECUTE_MBOXES)
                        ...
                        .optJSONObject(0)
                        .optJSONObject(ORDER)
                        .optJSONArray(PURCHASED_PRODUCT_IDS)
                        .length());
        assertEquals(
                "id1",
                json.optJSONObject(EXECUTE_MBOXES)
    ...
    @Test
    public void
            getRequestPayload_OrderParametersFromMap_NoOrderInJson_When_OrderTotalIsStringDouble() {
        // setup
        TargetParameters targetParameters =
                new TargetParameters.Builder()
                        .order(
    ...
    @Test
    public void
            getRequestPayload_OrderParametersFromMap_NoOrderInJson_When_OrderTotalIsRandomString() {
        // setup
        TargetParameters targetParameters =
                new TargetParameters.Builder()
                        .order(
    ...
    @Test
    public void
            getRequestPayload_OrderParametersFromMap_NoOrderInJson_When_PurchasedProductIdsIsEmpty() {
        // setup
        TargetParameters targetParameters =
                new TargetParameters.Builder()
                        .order(
    ...
    @Test
    public void
            getRequestPayload_OrderParametersFromMap_NoOrderInJson_When_PurchasedProductIdsOnlyContainsNoneString() {
        // setup
        TargetParameters targetParameters =
                new TargetParameters.Builder()
                        .order(
    ...
    public void getRequestPayload_ProductWhen_ProductParametersIsValid() {
        ...
        TargetParameters targetParameters =
                new TargetParameters.Builder().product(targetProduct).build();
        TargetRequest targetRequest =
                new TargetRequest("mbox", targetParameters, "default", callback -> {});
        List<TargetRequest> targetRequestList = new ArrayList<>();
        targetRequestList.add(targetRequest);
    ...
    public void getRequestPayload_PrefetchInJson() {
        ...
        ;
        final Map<String, Object> prefetchMbox1 =
                new HashMap<String, Object>() {
                    {
                        put("index", 0);
                        put("name", "mbox1");
        ...
        final Map<String, Object> prefetchMbox2 =
                new HashMap<String, Object>() {
                    {
                        put("index", 1);
                        put("name", "mbox2");
        ...
        // test
        JSONObject json =
                targetRequestBuilder.getRequestPayload(defaultJson, prefetch, null, null, null);
    ...
    public void getRequestPayload_NoPrefetchInJson_When_NullPrefetch() {
        ...
        // test
        JSONObject json =
                targetRequestBuilder.getRequestPayload(defaultJson, null, null, null, null);
    ...
    public void getRequestPayload_ExecuteInJson() {
        ...
        final JSONObject defaultJson = new JSONObject();
        ;
        final Map<String, Object> executeMbox1 =
                new HashMap<String, Object>() {
                    {
                        put("index", 0);
                        put("name", "mbox1");
        ...
        final Map<String, Object> executeMbox2 =
                new HashMap<String, Object>() {
                    {
                        put("index", 1);
                        put("name", "mbox2");
        ...
        // test
        JSONObject json =
                targetRequestBuilder.getRequestPayload(defaultJson, null, execute, null, null);
    ...
    public void getRequestPayload_NotificationsInJson() {
        ...
        final JSONObject defaultJson = new JSONObject();
        ;
        final Map<String, Object> notification1 =
                new HashMap<String, Object>() {
                    {
                        put("id", "0");
        ...
        final Map<String, Object> notification2 =
                new HashMap<String, Object>() {
                    {
                        put("id", "1");
                        put("timestamp", (long) (System.currentTimeMillis()));
        ...
        JSONObject json =
                targetRequestBuilder.getRequestPayload(
                        defaultJson, null, null, notifications, null);

        // verify
        assertEquals(2, json.optJSONArray(VISITED_MBOXES).length());
        assertEquals("0", json.optJSONArray(VISITED_MBOXES).optJSONObject(0).opt(ID));
        assertEquals(
                "display", json.optJSONArray(VISITED_MBOXES).optJSONObject(0).opt(METRIC_TYPE));
        assertEquals(
                "mbox1",
                json.optJSONArray(VISITED_MBOXES).optJSONObject(0).optJSONObject(MBOX).opt(NAME));
        assertEquals(
                "displayToken",
                json.optJSONArray(VISITED_MBOXES).optJSONObject(0).optJSONArray(TOKENS).opt(0));
        ...
        assertEquals(
                "mbox2",
                json.optJSONArray(VISITED_MBOXES).optJSONObject(1).optJSONObject(MBOX).opt(NAME));
        assertEquals(
                "clickToken",
                json.optJSONArray(VISITED_MBOXES).optJSONObject(1).optJSONArray(TOKENS).opt(0));
    ...
    public void getRequestPayload_PropertyTokenInJson_When_validToken() throws JSONException {
        ...
        JSONObject json =
                targetRequestBuilder.getRequestPayload(
                        defaultJson, null, null, null, "randomPropertyToken");
    ...
    public void getRequestPayload_PropertyTokenNotInJson_When_TokenIsEmpty() {
        ...
        JSONObject json =
                targetRequestBuilder.getRequestPayload(
                        null, getTargetRequestList(1), null, null, "", null, null);
    ...
    public void getRequestPayload_Mboxparameter_Key1_NotInJson_When_parameter_Key1_ValueIsNull() {
        ...
        assertNull(
                json.optJSONObject(EXECUTE_MBOXES)
                        ...
                        .optJSONObject(0)
                        .optJSONObject(PARAMETERS)
                        .optString("mBox-parameter-Key1", null));
        assertEquals(
                "mBox-Value2",
                json.optJSONObject(EXECUTE_MBOXES)
                        .optJSONArray(MBOXES)
    ...
    public void getRequestPayload_Mboxparameter_When_Mboxparameters_Are_Empty() {
        // setup
        TargetParameters targetParameters =
                new TargetParameters.Builder().parameters(new HashMap<>()).build();
        List<TargetRequest> targetRequestList = new ArrayList<>();
        TargetRequest targetRequest =
                new TargetRequest("mbox", targetParameters, "default", callback -> {});
        targetRequestList.add(targetRequest);
    ...
    public void getRequestPayload_ProfileWhen_ProfileParametersAreValid() {
        ...
        assertEquals(
                ...
                json.optJSONObject(EXECUTE_MBOXES)
                        .optJSONArray(MBOXES)
                        .optJSONObject(0)
                        .optJSONObject(PROFILE_PARAMETERS)
                        .opt("profile-parameter-Key1"));
        assertEquals(
                "profile-Value2",
                json.optJSONObject(EXECUTE_MBOXES)
                        .optJSONArray(MBOXES)
                        .optJSONObject(0)
                        .optJSONObject(PROFILE_PARAMETERS)
                        .opt("profile-parameter-Key2"));
    }

    @Test
    public void
            getRequestPayload_Profileparameter_Key1_NotInJson_When_parameter_Key1_ValueIsNull() {
        // setup
        TargetParameters targetParameters =
                new TargetParameters.Builder()
                        .profileParameters(
        ...
        assertNull(
                json.optJSONObject(EXECUTE_MBOXES)
                        ...
                        .optJSONObject(0)
                        .optJSONObject(PROFILE_PARAMETERS)
                        .optString("profile-parameter-Key1", null));
        assertEquals(
                "profile-Value2",
                json.optJSONObject(EXECUTE_MBOXES)
                        .optJSONArray(MBOXES)
    ...
    @Test
    public void
            getRequestPayload_PropertyParametersNotInJson_When_NullATPropertyInMboxParameters() {
        // setup
        TargetParameters targetParameters =
                new TargetParameters.Builder()
                        .parameters(
    ...
    public void getRequestPayload_ForMultipleMboxes_PropertyWhen_ATPropertyInMboxParameters() {
        ...
        List<TargetRequest> targetRequestList = new ArrayList<>();
        TargetRequest targetRequest1 =
                new TargetRequest("mbox1", targetParameters1, "default", callback -> {});
        TargetRequest targetRequest2 =
                new TargetRequest("mbox2", targetParameters2, "default", callback -> {});
        ...
        assertEquals(
                "profile-Value1",
                mbox1.optJSONObject(PROFILE_PARAMETERS).opt("profile-parameter-Key1"));
        ...
        assertEquals(
                "profile-Value2",
                mbox2.optJSONObject(PROFILE_PARAMETERS).opt("profile-parameter-Key2"));
        assertNull(mbox2.optJSONObject(PARAMETERS));
    }

    @Test
    public void
            getRequestPayload_ForMultipleMboxes_PropertyParametersNotInJson_When_NullATPropertyInMboxParameters() {
        // setup
        TargetParameters targetParameters1 =
                new TargetParameters.Builder()
                        .parameters(
    ...
    @Test
    public void
            getRequestPayload_PropertyWhen_ATPropertyInMboxParametersOverriddenByGlobalProperty() {
        // setup
        TargetParameters targetParameters =
                new TargetParameters.Builder()
                        .parameters(
        ...
        JSONObject json =
                targetRequestBuilder.getRequestPayload(
                        null, targetRequestList, null, null, "GlobalPropertyToken", null, null);
        ...
        assertEquals(
                "GlobalPropertyToken",
                json.optJSONObject(TargetJson.PROPERTY).optString(TargetJson.TOKEN, ""));
    }
    ...
    public void getRequestPayloadWithPrefetchRequests_PropertyWhen_ATPropertyInMboxParameters() {
        ...
        JSONObject json =
                targetRequestBuilder.getRequestPayload(
                        targetPrefetchList, null, null, null, null, null, null);
    ...
    public void
        ...
        JSONObject json =
                targetRequestBuilder.getRequestPayload(
                        targetPrefetchList, null, null, null, "GlobalPropertyToken", null, null);
    ...
    @Test
    public void
            getRequestPayloadWithPrefetchRequests_PropertyParametersNotInJson_When_NullATPropertyInMboxParameters() {
        // setup
        TargetParameters targetParameters =
                new TargetParameters.Builder()
                        .parameters(
    ...
    public void getRequestPayload_MidNotInJson_When_MidIsEmptyOrNull() {
        ...
        JSONObject json =
                targetRequestBuilder.getRequestPayload(
                        null, null, null, null, null, identitySharedState, null);
        ...
        JSONObject json2 =
                targetRequestBuilder.getRequestPayload(
                        null, null, null, null, null, identitySharedState2, null);
    ...
    public void getRequestPayload_BlobInJson_When_BlobIsValid() throws JSONException {
        ...
        // test
        assertEquals(
                json.optJSONObject(EXPERIENCE_CLOUD).optJSONObject(AAM_PARAMETERS).getString(BLOB),
                "blob");
    }

    @Test
    public void getRequestPayload_LocationHintInJson_When_LocationHintIsValid()
            throws JSONException {
        // setup
        Map<String, Object> identitySharedState =
                getIdentitySharedState("", "", "LocationHint", null);
        ...
        // test
        assertEquals(
                json.optJSONObject(EXPERIENCE_CLOUD)
                        .optJSONObject(AAM_PARAMETERS)
                        .getString(LOCATION_HINT),
                "LocationHint");
    }

    @Test
    public void getRequestPayload_LocationHintNotInJson_When_LocationHintIsEmptyOrNull()
            throws JSONException {
        // setup
        Map<String, Object> identitySharedState = getIdentitySharedState("", "", "", null);
    ...
    public void getRequestPayload_CustomerIdsInJson_When_CustomerIdsIsValid() throws JSONException {
        // setup
        final Map<String, Object> customVisitorID =
                new HashMap<String, Object>() {
                    {
                        ...
                        put(
                                VISITOR_IDS_STATE,
                                VisitorID.AuthenticationState.AUTHENTICATED.getValue());
                    }
                };
        final Map<String, Object> identitySharedState =
                getIdentitySharedState("", "", "", Arrays.asList(customVisitorID));
    ...
    @Test
    public void getRequestPayload_CustomerIdsInJson_OnlyPicks_ValidCustomerIDs()
            throws JSONException {
        // setup
        final Map<String, Object> customVisitorID1 =
                new HashMap<String, Object>() {
                    {
        ...
        // without ID
        final Map<String, Object> customVisitorID2 =
                new HashMap<String, Object>() {
                    {
        ...
        final Map<String, Object> customVisitorID3 =
                new HashMap<String, Object>() {
                    {
        ...
        final Map<String, Object> customVisitorID4 =
                new HashMap<String, Object>() {
                    {
        ...
        assertEquals(
                "Correct CustomerID id is set", gatheredVisitorID.get(CUSTOMER_ID_ID), "someID1");
        assertEquals(
                "Correct CustomerID IntegrationCode is set",
                gatheredVisitorID.get(CUSTOMER_ID_INTEGRATION_CODE),
                "someType1");
        assertEquals(
                "Correct CustomerID authentication state is set",
                gatheredVisitorID.get(CUSTOMER_ID_AUTHENTICATION_STATE),
                "logged_out");
    }

    @Test
    public void getRequestPayload_CustomerIdsInJson_When_CustomerIdsIsValid_AndLoggedOut()
            throws JSONException {
        // setup
        final Map<String, Object> customVisitorID =
                new HashMap<String, Object>() {
    ...
    @Test
    public void getRequestPayload_CustomerIdsInJson_When_CustomerIdsIsValid_AndUnknown()
            throws JSONException {
        // setup
        final Map<String, Object> customVisitorID =
                new HashMap<String, Object>() {
        ...
        testVisitorIDList.add(
                new VisitorID("d_cid_ic", "id1", "hodor", VisitorID.AuthenticationState.UNKNOWN));
        Map<String, Object> identitySharedState =
                getIdentitySharedState("", "", "", Arrays.asList(customVisitorID));
    ...
    @Test
    public void getRequestPayload_CustomerIdsNotInJson_When_CustomerIdsIsEmptyOrNull()
            throws JSONException {
        // setup
        Map<String, Object> identitySharedState =
                getIdentitySharedState("", "", "", new ArrayList<>());
    ...
    public void getRequestPayload_LifecycleDataNotInJson_When_LifecycleIsEmptyOrNull() {
        ...
        json =
                targetRequestBuilder.getRequestPayload(
                        null, getTargetRequestList(1), null, null, null, null, new HashMap<>());
    ...
    public void getRequestPayload_LifecycleDataInMboxParameters_When_LifecycleIsValid() {
        ...
        JSONObject json =
                targetRequestBuilder.getRequestPayload(
                        null, getTargetRequestList(1), null, null, null, null, lifecycleData);

        // verify
        assertEquals(
                new JSONObject(lifecycleData).toString(),
                json.optJSONObject(EXECUTE_MBOXES)
                        .optJSONArray(MBOXES)
                        .optJSONObject(0)
                        .optJSONObject(PARAMETERS)
    ...
    public void getDisplayNotificationJsonObject_ReturnNull_When_InputJsonIsNull() {
        // test
        JSONObject json =
                targetRequestBuilder.getDisplayNotificationJsonObject(null, null, null, 123L, null);
    ...
    @Test
    public void
            getDisplayNotificationJsonObject_ReturnObjectWithTimeStampAndMetricType1_When_InputJsonIsNotNull()
                    throws JSONException {
        // setup
        ...
        // test
        JSONObject visitedMboxNode =
                targetRequestBuilder.getDisplayNotificationJsonObject(
                        "mboxName", json, null, 123L, null);
    ...
    public void getClickNotificationJsonObject_When_InputJsonIsNotNull() throws JSONException {
        ...
        JSONObject clickJson =
                targetRequestBuilder.getClickNotificationJsonObject(mboxJson, null, 123L, null);
    ...
    @Test
    public void
            getClickNotificationJsonObject_ReturnObjectWithTimeStampAndMetricType_When_InputJsonIsNull() {
        // test
        JSONObject json =
    ...
    public void getDefaultJsonObject_CustomParameters() {
        ...
        Map<String, Object> experienceCloudId =
                new HashMap<String, Object>() {
                    {
                        put("ecid", "customEcid");
                    }
        ...
        JSONObject json =
                targetRequestBuilder.getDefaultJsonObject(
                        ...
                        experienceCloudId,
                        1234L,
                        getIdentitySharedState("mcid", "blob", "locationHint", new ArrayList<>()));

        // verify
        assertEquals(new JSONObject(idMap).toString(), json.optJSONObject(ID).toString());
        assertEquals(
                new JSONObject(contextMap).toString(),
                json.optJSONObject(CONTEXT_PARAMETERS).toString());
        assertEquals(
                new JSONObject(experienceCloudId).toString(),
                json.optJSONObject(EXPERIENCE_CLOUD).toString());
    ...
    List<TargetRequest> getTargetRequestList(int count) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            TargetRequest targetRequest =
                    new TargetRequest(mboxName, null, "default", callback -> {});
            targetRequestList.add(targetRequest);
        }
    ...
    Map<String, Object> getIdentitySharedState(
            final String marketingCloudId,
            final String blob,
